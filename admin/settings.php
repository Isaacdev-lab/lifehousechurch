			...
			<div id="page-wrapper">
               ...
               ?> 
                <form class="com-mail"  action="save-setting.php" method="post" enctype="multipart/form-data">
												...
												<input type="text" name="youtube" value="<?php echo $row['youtube']; ?>" class="form-control1 control3">
												<label>Twitter Account </label>
												<input type="text" name="twitter" value="<?php echo $row['youtube']; ?>" class="form-control1 control3">
												<label>Instagram Account</label>
												<input type="text" name="instagram" value="<?php echo $row['instagram']; ?>" class="form-control1 control3">
