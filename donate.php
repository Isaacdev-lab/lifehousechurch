        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">RCCG Life House Church, Lagos</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 2021</span>
                  <span><i class="fa fa-archive"></i> <a href="#">RCCG Life House Church</a>, <a href="#">Lagos</a></span>
                </span>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                        	...
                        	<div class="col-md-6">
                                ...
                                <div class="input-group margin-20">
                                    ...
                                    <select name="donation amount" class="form-control">
                                        ...
                                        <option value="50">100,000</option>
                                        <option value="100">1M</option>
                                        <option value="Custom">100M+</option>
                                    </select>
                                </div>
                            </div>
                  ...
                  <div class="modal-footer">
                    <p class="small short text-center btn-primary">If you would prefer to call in your donation, please call +234-706-861-2360</p>
                  </div>
                </div>
              </div>
            </div>
